...
function openPlayer(movie) {
    ...
    if (!movie.streamLink || movie.streamLink.trim() === '') {
        showToast('Streaming link not available yet', 'error');
        return;
    }
    
    // Track movie view with GA4
    if (typeof gtag !== 'undefined') {
    ...
    // Open in new tab
    window.open(movie.streamLink, '_blank');
